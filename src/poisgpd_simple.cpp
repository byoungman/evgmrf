...
arma::vec tppu1(arma::vec pars, double u, double w)
{
  ...
  double ee10, ee11, ee12, ee13, ee14, ee15, ee18;
...
arma::vec tppz1(arma::vec pars, arma::vec zv)
{
  ...
  double ee10, ee11, ee12, ee13, ee15, ee19;
  double ee20;
  double z;
  double w = 1.0;
...
//  ee18 = (ee12 * (1.5 - 1.5 * ee14) - 1.5/ee5) * ee2;
  ...
  g(0) += w * (-(ee19/ee11));
  g(1) += w * (1 - ee19 * ee7/ee11);
  g(2) += w * ((1.5 * (ee12 * ee7/ee11) - 1.5 * (ee20/ee15)) * ee2/ee13);
...
arma::mat tppz2(arma::vec pars, arma::vec zv)
{
  ...
  double ee2, ee3, ee5, ee6, ee7, ee8, ee9;
  double ee10, ee11, ee12, ee13, ee14, ee15, ee17, ee18;
  double ee20;
  double z;
  double w = 1.0;
...
//    ee19 = ee12 * ee5;
    ...
    h(0, 0) += w * (- (ee12 * ee15/(R_pow(ee10, 2) * R_pow(ee6, 2))));
    h(1, 0) += w * ((1 - ee14) * ee12 * ee5/ee11);
    h(2, 0) += w * (-(ee18/ee17));
    h(1, 1) += w * (-((ee14 - 1) * ee12 * ee5 * ee7/ee11));
    h(2, 1) += w * (-(ee18 * ee7/ee17));
    h(2, 2) += w * (-(((((2.25 * (ee7/(ee10 * ee3 * ee6)) - 3) * ee2/ee3 +
      1.5) * ee12 + 2.25 * (ee2/(ee13 * ee15))) * ee7/ee11 +
      (2.25 * (ee2 * ee7/ee17) - ((4.5/(ee3 * ee5) - 3) * ee2/ee3 +
      1.5) * ee20)/ee15) * ee2/ee13));
